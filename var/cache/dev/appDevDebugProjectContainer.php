...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('PiRKK18H5R', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5YMGrZqEO-', 0, 'Fgrrz2rvsqc9pjzZzpPZHB', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\HomeBlog\\DefaultBundle\\Entity'))), 'HomeBlog\\DefaultBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('HomeBlogDefaultBundle' => 'HomeBlog\\DefaultBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_27afd0da7340cbe3702f3f8f0f512fd17b2dc99b21e1482f42ec7728ac3d5531');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\HomeBlog\\DefaultBundle/Resources/views'), 'HomeBlogDefault');
        $instance->addPath(($this->targetDirs[3].'\\src\\HomeBlog\\AdminBundle/Resources/views'), 'HomeBlogAdmin');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Df58v2zeZX', 0, 'Fgrrz2rvsqc9pjzZzpPZHB', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('591897807fd870.26409008')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'HomeBlogDefaultBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\HomeBlog\\DefaultBundle'),
                    'namespace' => 'HomeBlog\\DefaultBundle',
                ),
                'HomeBlogAdminBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\HomeBlog\\AdminBundle'),
                    'namespace' => 'HomeBlog\\AdminBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'HomeBlogDefaultBundle' => 'HomeBlog\\DefaultBundle\\HomeBlogDefaultBundle',
                'HomeBlogAdminBundle' => 'HomeBlog\\AdminBundle\\HomeBlogAdminBundle',
